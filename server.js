...
const SHOPIFY_STORE = 'your-store.myshopify.com'; // Replace with your store URL (e.g., 'my-store.myshopify.com')
const ACCESS_TOKEN = 'your-admin-api-access-token'; // Replace with your access token (starts with shpat_)
